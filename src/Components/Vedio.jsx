      ...
      <div className="absolute inset-0 flex items-center justify-start pl-8 md:pl-16 lg:pl-24">
        <div className="max-w-2xl space-y-4 text-left">
          <h1 className="text-4xl font-extrabold leading-tight md:text-5xl">
            ...
            <span className="text-[#FFD700] bg-gradient-to-r from-[#1a365d]/90 to-[#0f4c81]/90 px-4 py-1 rounded-lg">
              Graduate in the UK
            </span>
          </h1>

          <p className="text-xl text-white font-medium bg-black/60 px-4 py-2 rounded-lg border-l-4 border-[#FFD700]">
